          ...
          <Card><br/>
            ...
            <Row>
              <Col sm="12" md={{ size: 12, offset: 0 }}>
                <Card body inverse color="Confirmed"   style = {{ marginLeft : 20 ,marginRight : 20}}>
            ...
            <Row>
              <Col>
                <Card body inverse color="Recovered" style = {{ marginLeft : 20 }}>
              ...
              <Col>
                <Card body inverse color="Deaths" style = {{ marginRight : 20}}>
